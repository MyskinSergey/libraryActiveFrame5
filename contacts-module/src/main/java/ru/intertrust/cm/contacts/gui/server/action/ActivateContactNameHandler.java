...
public class ActivateContactNameHandler extends SimpleActionHandler {
    ...
    public SimpleActionData executeAction(SimpleActionContext context) {
        ...
        if (rootObjectId != null) {
            ...
            if (!dobjectsManager.getStatusById(rootDomainObject.getStatus()).equals(STATUS_ACTIVATED)) {
                dobjectsManager.changeStatusForDo(rootDomainObject.getId(), STATUS_ACTIVATED);
            }
        }
        return actionData;
    }
