...
@ExtensionPoint(filter = "Occa_Occasion_Fixed")
public class OccasionFixedBeforeSaveExtensionPoint implements BeforeSaveExtensionHandler {


        private static String FIELD_TYPE = "Occasion_Type";
        private static Long FIRST_TYPE = 1l;
