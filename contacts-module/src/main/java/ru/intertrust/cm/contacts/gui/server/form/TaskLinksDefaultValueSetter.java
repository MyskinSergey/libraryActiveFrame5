 ...
 */
@ComponentName("tasklinks.value.setter")
public class TaskLinksDefaultValueSetter implements FormDefaultValueSetter {
    @Override
    ...
    public Value getDefaultValue(FormState formState, FieldPath fieldPath) {
        if("task_from".equalsIgnoreCase(fieldPath.getPath())) {
